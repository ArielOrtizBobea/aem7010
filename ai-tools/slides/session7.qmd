...
2. **Install Claude Code.** `npm install -g @anthropic-ai/claude-code`, then `claude --version`. Full guide at <https://docs.claude.com/en/docs/claude-code/setup>. Free Claude account required.
